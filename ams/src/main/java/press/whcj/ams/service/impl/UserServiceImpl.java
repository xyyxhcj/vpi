...
public class UserServiceImpl implements UserService {
	...
	public void remove(User user) {
		FastUtils.checkParams(user.getId());
	...
	public UserVo login(UserDto userDto, HttpServletRequest request) {
		...
		UserVo existUser = mongoTemplate.findOne(new Query(Criteria.where(ColumnName.LOGIN_NAME).is(userDto.getLoginName())), UserVo.class, Constant.CollectionName.USER);
		if (existUser == null) {
